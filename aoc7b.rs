...
fn main() {
    ...
    for m_line in lines {
        ...
        hand_sorted.push((&'!',&0));
        let rank;
        if *hand_sorted[0].1 + joks == 5 {
            rank = 7
        } else if *hand_sorted[0].1 + joks == 4 {
            rank = 6
        } else if *hand_sorted[0].1 + *hand_sorted[1].1 + joks == 5 {
            rank = 5
        } else if *hand_sorted[0].1 + joks == 3 {
            rank = 4
        } else if *hand_sorted[0].1 + *hand_sorted[1].1 + joks == 4 {
            rank = 3
        } else if *hand_sorted[0].1 + joks == 2 {
            rank = 2
        } else {
            rank = 1
        }
